        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          <tbody id="list-san-pham">
            <?php
              ...
              $query = "SELECT hoadons.id 
                                AS 'id_hoa_don', users.id 
                                AS 'id_nguoi_dung', dia_chi_nhan_hang,sum(chitiethoadons.so_luong * chitiethoadons.don_gia) 
                                AS tong_tien ,tinh_trang_thanh_toan, ngay_tao
                                FROM hoadons,chitiethoadons,users
                                WHERE chitiethoadons.hoa_don_id = hoadons.id AND hoadons.user_id = users.id
                                GROUP BY chitiethoadons.hoa_don_id 
                                LIMIT ?, ?";
            ...
            ?>
              <tr>
                ...
                <td>
                  <button class="btn btn-secondary btn-xem-chi-tiet-hoa-don" data-bill_id="<?= $hoadon["id_hoa_don"]; ?>" data-sum="<?= $hoadon["tong_tien"]; ?>" data-pay-status="<?= $hoadon["tinh_trang_thanh_toan"]; ?>">
