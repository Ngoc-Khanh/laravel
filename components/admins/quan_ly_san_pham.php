            ...
            <tbody id="list-san-pham">
              <?php
                ...
                $query = "SELECT sanphams.id, ten_san_pham, ten_loai_san_pham, loai_san_pham_id, mo_ta_san_pham, don_gia, so_luong, hinh_anh, ngay_dang 
                  FROM sanphams, loaisanphams 
                  WHERE sanphams.loai_san_pham_id = loaisanphams.id 
                  AND sanphams.da_xoa = 0 
                  LIMIT ?,?";
              ...
              ?>
                <tr id="san-pham<?= $sanpham["id"]; ?>">
                  ...
                  <td>
                    <button class="btn-sua-san-pham btn btn-primary" data-name="<?= $sanpham["ten_san_pham"]; ?>" data-id="<?= $sanpham["id"]; ?>" data-count="<?= $sanpham["so_luong"]; ?>" data-price="<?= $sanpham["don_gia"]; ?>" data-name_type="<?= $sanpham["loai_san_pham_id"]; ?>" data-image="<?= $sanpham["hinh_anh"]; ?>">
                      Sửa
                    </button>
