...
<body style="background-image: url(<?php echo _DIR_['IMG']['USERS'] . 'bg-img/' . 'login-bg.jpg'; ?>); background-size: cover; background-position: center;">
            ...
            <div class="col-md-3 border-right">
                ...
                ?>
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                        <img class="rounded-circle mt-5" src="<?php echo _DIR_['IMG']['USERS'] . "info/image.jpg" ?>" width="150px">
                        <span class="font-weight-bold" style="padding: 5px; font-size: 1.5rem"><?php echo $user_info[0]["name"]; ?></span>
            ...
            <div class="col-md-9">
                <div class="p-3 py-5 tab-content">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a href="index.php" class="btn btn-primary" style> <i class='bx bxs-left-arrow'></i> Về trang chủ</a>
